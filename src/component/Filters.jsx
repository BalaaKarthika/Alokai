...
const filtersData = [
  ...
  },
  {
    ...
    type: 'category',
    details: [
      { id: 'CLOTHING', label: 'Clothing', value: 'clothing', counter: 30, link: '#' },
      { id: 'SHOES', label: 'Shoes', value: 'shoes', counter: 28, link: '#' },
      { id: 'ACCESSORIES', label: 'Accessories', value: 'accessories', counter: 56, link: '#' },
      { id: 'WEARABLES', label: 'Wearables', value: 'wearables', counter: 12, link: '#' },
      { id: 'FOOD_DRINKS', label: 'Food & Drinks', value: 'food and drinks', counter: 52, link: '#' },
    ],
  },
  {
    id: 'acc3',
    ...
    type: 'color',
    details: [
      { id: 'c1', label: 'Primary', value: 'bg-primary-500', counter: 10 },
      { id: 'c2', label: 'Black and gray', value: 'bg-[linear-gradient(-45deg,#000_50%,#d1d5db_50%)]', counter: 5 },
      { id: 'c3', label: 'Violet', value: 'bg-violet-500', counter: 0 },
      { id: 'c4', label: 'Red', value: 'bg-red-500', counter: 2 },
      { id: 'c5', label: 'Yellow', value: 'bg-yellow-500', counter: 100 },
      { id: 'c6', label: 'Avocado', value: 'bg-gradient-to-tr from-yellow-300 to-primary-500', counter: 14 },
    ],
  },
  {
    id: 'acc4',
      ...
      {filtersData.map((section) => (
        <Fragment key={section.id}>
              ...
              <div className="flex justify-between p-2 mb-2">
                ...
                <SfIconChevronLeft
                  className={classNames('text-neutral-500', {
                    'rotate-90': isAccordionItemOpen(section.id),
                    '-rotate-90': !isAccordionItemOpen(section.id),
                  })}
                />
              </div>
          ...
          >
            ...
            {section.type === 'checkbox' && section.details.map(({ label, value, counter }) => (
              <SfListItem
                key={value}
                as="label"
                size="sm"
